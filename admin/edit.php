...
elseif($Reviewed == ""){
      ...
      if(update_item($Name, $Distillery, $Proof, $Score, $Reviewed, $id)){
        header('Location: ../admin/admin.php');
        exit;
      }else{
        $error_message='Could not edit review.';
      }
    }
}//IF POST
?>
...
<header>
    <h1 class='title'> Edit Bourbon Review </h1>
</header>
...
<form class="addForm" method="Post" action"#">
  ...
  <label for="Distillery"> Distillery: </label>
    ...
    <input class="submit" name="submit" type="submit" value="Update Review">
